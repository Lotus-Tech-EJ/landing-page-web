...
export function ServiceCard({ service }: ServiceCardProps) {
    return (
        <article className="group relative aspect-[4/3] w-full overflow-hidden rounded-[2rem] bg-white border border-gray-100 shadow-md transition-transform duration-300 hover:scale-[1.02]">
            ...
            {/*parte de imagem comentada*/}
            {/*<Image
                src={service.image}
                alt=""
                placeholder="blur"
                className="h-full w-full object-cover object-center transition-all duration-500 ease-out group-hover:scale-105 group-hover:blur-md group-hover:opacity-30"
            />*/}
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6">
                ...
                {/* hover para descricao e botao saiba mais
                 de antemao, o botao nao faz nada, nao tem tela de design feita ou explicando isso*/}
